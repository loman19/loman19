...
|---|---|
| [rewards-discount-engine](https://github.com/loman19/rewards-discount-engine) | Rewards & discount engine (Instant Bank Discount, No Cost EMI, Exchange Discount) with idempotent, replay-safe request handling |
